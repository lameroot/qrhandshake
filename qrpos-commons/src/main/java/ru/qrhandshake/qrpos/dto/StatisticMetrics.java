...
public class StatisticMetrics {
    ...
    public static StatisticMetrics create(@NotNull Statistic.StatisticType type, @NotNull Merchant merchant, @Nullable OrderTemplate orderTemplate, long value, @NotNull Date timestamp) {
    ...
    public boolean isValid() {
        return null != merchant && null != type && 0L != value && null != timestamp;
    }
}
